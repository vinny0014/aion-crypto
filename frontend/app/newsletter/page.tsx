...
export const metadata: Metadata = { title: "Crypto alerts", description: "Choose AION Crypto breaking-news and market alert preferences.", alternates: { canonical: "/newsletter" }, robots: { index: false, follow: true } };
