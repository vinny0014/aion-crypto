...
def build_market_brief(rows: list[dict], captured_at: datetime, source: str) -> dict:
    ...
    body = (
        ...
        "Why this snapshot matters: it provides a consistent context record for comparing the same tracked "
        "assets at a known time. It does not identify the cause of a move, prove a trend or replace current "
        "liquidity checks. The practical impact is limited to observation; any investment conclusion needs "
        "separate evidence about news, market structure, supply and risk.\n\n"
